...
react_system_template: Template = Template(
    #Question for team: Should I change the system prompt?
...
if __name__ == "__main__":
    ...
    def give_link_to_medical_services(service: str):
        """Returns a link to the specified medical service."""
        return f"https://calyouth.org/cycl/"
